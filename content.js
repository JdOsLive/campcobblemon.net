...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 12, name: "Bidoof (Scuba)",         group: "bidoof", where: ["Ocean", "Deep Ocean"], types: ["Water"], ability: "Volt Absorb / Simple (hidden: Moody)", stats: [70, 60, 60, 45, 55, 30], role: "Bulky water", rarity: "Ultra Rare", moves: ["Water Gun", "Bubble", "Aqua Jet", "Dive", "Water Pulse", "Aqua Tail", "Liquidation", "Hydro Pump", "Surf", "Scald"], designer: "Lazaro", added: "2025-03-03" },
    ...
    { row: 17, name: "Bidoof (Sly Cooper)",    group: "bidoof", where: ["Taiga"], types: ["Dark"], ability: "Pickpocket / Simple (hidden: Moody)", stats: [60, 75, 50, 35, 55, 45], role: "Sneaky physical attacker", rarity: "Ultra Rare", moves: ["Thief", "Quick Attack", "Feint Attack", "Bite", "Sucker Punch", "Night Slash", "Knock Off", "Foul Play", "U-turn", "Taunt"], designer: "Bowtie", added: "2025-03-28" },
    ...
    { row: 20, name: "Bidoof (Wario)",         group: "bidoof", where: ["Badlands"], types: ["Poison"], ability: "Stench / Simple (hidden: Moody)", stats: [70, 60, 55, 40, 55, 40], role: "Bulky physical attacker", rarity: "Ultra Rare", moves: ["Poison Gas", "Acid", "Bite", "Poison Fang", "Crunch", "Poison Jab", "Knock Off", "Toxic"], designer: "Bowtie", added: "2025-04-19" },
    ...
    { row: 33, name: "Bidoof (Camper)",        group: "bidoof", where: ["Forest", "Taiga", "Plains", "Meadow"], types: ["Normal"], ability: "Intimidate / Simple (hidden: Moody)", stats: [75, 58, 51, 45, 51, 40], role: "Well-rounded camper", rarity: "Rare", moves: ["Camouflage", "Round", "Nature Power", "Body Slam", "Bulk Up", "Double-Edge", "Slack Off", "Rest", "Work Up"], designer: "tortu152", added: "2026-09-07" },
