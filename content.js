...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 12, name: "Bidoof (Scuba)",         group: "bidoof", where: ["Ocean", "Deep Ocean"], types: ["Water"], ability: "Volt Absorb / Simple (hidden: Moody)", stats: [70, 60, 60, 45, 55, 30], role: "Bulky water", rarity: "Ultra Rare", moves: ["Water Gun", "Bubble", "Aqua Jet", "Waterfall", "Dive", "Aqua Tail", "Liquidation", "Surf", "Rain Dance"], designer: "Lazaro", added: "2025-03-03" },
    ...
    { row: 34, name: "Bidoof (Spider-Man)",   group: "bidoof", where: ["Towns and cities", "Villages"], types: ["Bug", "Flying"], ability: "Anticipation / Simple (hidden: Moody)", stats: [55, 75, 55, 35, 45, 55], role: "Fast physical attacker", rarity: "Ultra Rare", moves: ["String Shot", "Quick Attack", "Bug Bite", "Aerial Ace", "Spider Web", "Lunge", "X-Scissor", "Skitter Smack", "U-turn", "Agility"], designer: "tortu152", added: "2026-09-07" },
