...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 39, name: "Campion Koffing",   group: "campion", species: "Koffing",   dex: "#109", form: "Campion form", types: ["Poison", "Ghost"], rarity: "Rare",       where: ["Basalt Deltas", "Soul Sand Valley", "Nether Wastes"], ability: "Levitate / Flash Fire (hidden: Cursed Body)", flavor: "A variation of Koffing from Camp Cobblemon that drifts through the ash and soul sand of the Nether. Pale and hollow-eyed, it hangs in the air like something that never quite finished dying, and the gas it leaks burns cold rather than hot.", designer: "", added: "2026-09-15", stats: [45, 70, 100, 70, 55, 40] },
    { row: 40, name: "Campion Weezing",   group: "campion", species: "Weezing",   dex: "#110", form: "Campion form", types: ["Poison", "Ghost"], rarity: "Ultra Rare", where: ["Basalt Deltas", "Soul Sand Valley", "Nether Wastes"], how: "Evolve Campion Koffing at level 35", ability: "Levitate / Flash Fire (hidden: Cursed Body)", flavor: "A variation of Weezing from Camp Cobblemon found deep in the Nether. Two heads, a tangle of trailing tentacles, and a wail that carries across the wastes. Campers who hear it say the lava goes quiet.", designer: "", added: "2026-09-15", stats: [70, 95, 130, 95, 80, 65] },
  ],
