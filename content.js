...
window.CC = {
  ...
  pokemon: [
    { row: 5,  name: "Bidoof (Helldivers)",    group: "bidoof", where: ["The End"], types: ["Steel", "Fighting"], ability: "Justified / Simple (hidden: Moody)", stats: [60, 85, 65, 30, 45, 35], role: "Armored bruiser", rarity: "Ultra Rare", moves: ["Metal Claw", "Rock Smash", "Brick Break", "Iron Head", "Body Press", "Close Combat", "Flash Cannon", "Bulk Up"], designer: "maashous", added: "2025-01-06" },
    ...
    { row: 10, name: "Bidoof (King)",          group: "bidoof", where: ["Plains"], types: ["Normal", "Psychic"], ability: "Dazzling / Simple (hidden: Moody)", stats: [70, 70, 60, 30, 50, 40], role: "Physical royal", rarity: "Ultra Rare", moves: ["Quick Attack", "Body Slam", "Zen Headbutt", "Stomping Tantrum", "Double-Edge", "Psychic Fangs", "Bulk Up"], designer: "Lazaro", added: "2025-03-03" },
    { row: 11, name: "Bidoof (Queen)",         group: "bidoof", where: ["Plains"], types: ["Normal", "Psychic"], ability: "Queenly Majesty / Simple (hidden: Moody)", stats: [70, 30, 50, 70, 60, 40], role: "Special royal", rarity: "Ultra Rare", moves: ["Confusion", "Round", "Psybeam", "Calm Mind", "Hyper Voice", "Psychic", "Dazzling Gleam"], designer: "Lazaro", added: "2025-03-03" },
    { row: 12, name: "Bidoof (Scuba)",         group: "bidoof", where: ["Ocean", "Deep Ocean"], types: ["Water", "Ground"], ability: "Water Absorb / Simple (hidden: Moody)", stats: [70, 60, 60, 45, 55, 30], role: "Bulky water", rarity: "Ultra Rare", moves: ["Water Gun", "Mud-Slap", "Aqua Jet", "Bulldoze", "Water Pulse", "Aqua Tail", "Liquidation", "Earthquake", "Surf", "Scald"], designer: "Lazaro", added: "2025-03-03" },
    { row: 13, name: "Bidoof (Kratos)",        group: "bidoof", where: ["Jagged Peaks", "Frozen Peaks"], types: ["Fighting"], ability: "Defiant / Simple (hidden: Moody)", stats: [60, 85, 55, 30, 45, 45], role: "Glass cannon", rarity: "Ultra Rare", moves: ["Rock Smash", "Shadow Sneak", "Double Kick", "Brick Break", "Shadow Claw", "Close Combat", "Reversal", "Bulk Up"], designer: "Bowtie", added: "2025-03-28" },
    { row: 14, name: "Bidoof (Aloy)",          group: "bidoof", where: ["Jungle"], types: ["Grass", "Steel"], ability: "Sniper / Simple (hidden: Moody)", stats: [60, 80, 55, 35, 45, 45], role: "Physical attacker", rarity: "Ultra Rare", moves: ["Vine Whip", "Metal Claw", "Razor Leaf", "Iron Head", "Seed Bomb", "Leaf Blade", "Flash Cannon", "Swords Dance"], designer: "Bowtie", added: "2025-03-28" },
    { row: 15, name: "Bidoof (Ratchet & Clank)", group: "bidoof", where: ["Trial Chambers"], types: ["Steel", "Flying"], ability: "Analytic / Simple (hidden: Moody)", stats: [60, 40, 55, 70, 50, 45], role: "Special attacker", rarity: "Ultra Rare", moves: ["Metal Claw", "Gust", "Air Cutter", "Flash Cannon", "Charge Beam", "Air Slash", "Iron Head", "Steel Beam", "Roost", "Volt Switch"], designer: "Bowtie", added: "2025-03-28" },
    { row: 16, name: "Bidoof (Astro Bot)",     group: "bidoof", where: ["The End"], types: ["Electric"], ability: "Motor Drive / Simple (hidden: Moody)", stats: [60, 40, 60, 55, 55, 50], role: "Fast special attacker", rarity: "Ultra Rare", moves: ["Thunder Shock", "Gust", "Spark", "Air Cutter", "Electro Ball", "Air Slash", "Discharge", "Roost", "Volt Switch"], designer: "Bowtie", added: "2025-03-28" },
    { row: 17, name: "Bidoof (Sly Cooper)",    group: "bidoof", where: ["Taiga"], types: ["Dark", "Ghost"], ability: "Pickpocket / Simple (hidden: Moody)", stats: [60, 50, 65, 35, 65, 45], role: "Sneaky physical attacker", rarity: "Ultra Rare", moves: ["Thief", "Astonish", "Feint Attack", "Shadow Sneak", "Sucker Punch", "Shadow Claw", "Knock Off", "Foul Play", "U-turn", "Phantom Force"], designer: "Bowtie", added: "2025-03-28" },
    { row: 18, name: "Bidoof (Mario)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Crimson Forest", "Warped Forest"], types: ["Fire"], ability: "Blaze / Simple (hidden: Moody)", stats: [60, 70, 45, 60, 45, 40], role: "Mixed attacker", rarity: "Ultra Rare", moves: ["Ember", "Rock Smash", "Flame Charge", "Double Kick", "Fire Fang", "High Jump Kick", "Flare Blitz", "Flamethrower"], designer: "Bowtie", added: "2025-04-19" },
    { row: 19, name: "Bidoof (Luigi)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Warped Forest"], types: ["Ice"], ability: "Refrigerate / Simple (hidden: Moody)", stats: [60, 70, 50, 45, 50, 45], role: "Physical attacker (ice balls)", rarity: "Ultra Rare", moves: ["Powder Snow", "Ice Shard", "Ice Fang", "Avalanche", "Icicle Crash", "Double-Edge", "Blizzard", "Ice Beam"], designer: "Bowtie", added: "2025-04-19" },
    { row: 20, name: "Bidoof (Wario)",         group: "bidoof", where: ["Badlands"], types: ["Poison"], ability: "Stench / Simple (hidden: Moody)", stats: [70, 60, 55, 30, 55, 50], role: "Bulky physical attacker", rarity: "Ultra Rare", moves: ["Poison Gas", "Acid", "Bite", "Poison Fang", "Crunch", "Poison Jab", "Knock Off", "Toxic"], designer: "Bowtie", added: "2025-04-19" },
    { row: 21, name: "Bidoof (Waluigi)",       group: "bidoof", where: ["Mushroom Fields"], types: ["Dark", "Poison"], ability: "Prankster / Simple (hidden: Moody)", stats: [60, 45, 55, 60, 55, 45], role: "Trickster / special", rarity: "Ultra Rare", moves: ["Feint Attack", "Acid", "Snarl", "Torment", "Dark Pulse", "Sludge Bomb", "Foul Play", "Nasty Plot", "Taunt"], designer: "Bowtie", added: "2025-04-19" },
    { row: 22, name: "Bidoof (Donkey Kong)",   group: "bidoof", where: ["Jungle"], types: ["Fighting", "Grass"], ability: "Gorilla Tactics / Simple (hidden: Moody)", stats: [70, 85, 55, 30, 45, 35], role: "Physical bruiser", rarity: "Ultra Rare", moves: ["Rock Smash", "Vine Whip", "Bullet Seed", "Brick Break", "Seed Bomb", "Hammer Arm", "Wood Hammer", "Bulk Up"], designer: "Bowtie", added: "2025-04-19" },
    ...
    { row: 24, name: "Bidoof (Zelda, Echoes of Wisdom)",   group: "bidoof", where: ["Cherry Grove"], types: ["Psychic"], ability: "Magic Bounce / Simple (hidden: Moody)", stats: [60, 35, 50, 75, 55, 45], role: "Special support", rarity: "Ultra Rare", moves: ["Confusion", "Psybeam", "Calm Mind", "Psyshock", "Psychic", "Future Sight", "Reflect", "Light Screen"], designer: "Bowtie", added: "2025-04-19" },
    { row: 33, name: "Bidoof (Scout)",        group: "bidoof", where: ["Forest", "Taiga", "Plains", "Meadow"], types: ["Normal"], ability: "Fur Coat / Simple (hidden: Moody)", stats: [75, 58, 51, 45, 51, 40], role: "Well-rounded camper", rarity: "Common", moves: ["Camouflage", "Round", "Nature Power", "Body Slam", "Bulk Up", "Double-Edge", "Slack Off", "Rest", "Work Up"], designer: "TBC", added: "2026-09-07" },
    { row: 34, name: "Bidoof (Spider-Man)",   group: "bidoof", where: ["Lush Caves", "Dripstone Caves"], types: ["Bug", "Psychic"], ability: "Anticipation / Simple (hidden: Moody)", stats: [55, 80, 50, 35, 45, 55], role: "Fast physical attacker", rarity: "Ultra Rare", moves: ["String Shot", "Quick Attack", "Bug Bite", "Spider Web", "Agility", "Lunge", "X-Scissor", "Extrasensory", "U-turn", "Sticky Web"], designer: "TBC", added: "2026-09-07" },
    { row: 35, name: "Bidoof (Subaru)",       group: "bidoof", where: ["Dark Forest, at night"], types: ["Psychic", "Ghost"], ability: "Sturdy / Simple (hidden: Moody)", stats: [65, 40, 55, 70, 45, 45], role: "Refuses to stay down", rarity: "Ultra Rare", moves: ["Astonish", "Confusion", "Endure", "Hex", "Psybeam", "Destiny Bond", "Future Sight", "Protect", "Psychic"], designer: "TBC", added: "2026-09-07" },
