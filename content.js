...
window.CC = {
  ...
  pokemon: [
    { row: 5,  name: "Bidoof (Helldivers)",    group: "bidoof", where: ["The End"], types: ["Steel", "Fighting"], ability: "Justified / Simple (hidden: Moody)", stats: [60, 85, 70, 30, 45, 30], role: "Armored bruiser", moves: ["Metal Claw", "Rock Smash", "Brick Break", "Iron Head", "Body Press", "Close Combat", "Flash Cannon", "Bulk Up"], designer: "maashous", added: "2025-01-06" },
    ...
    { row: 7,  name: "Bidoof (Ruby)",          group: "bidoof", where: ["Snowy Peaks", "Stony Peaks", "Jagged Peaks", "Frozen Peaks"], types: ["Rock", "Fire"], ability: "Solid Rock / Simple (hidden: Moody)", stats: [65, 80, 65, 40, 40, 30], role: "Physical wall-breaker", moves: ["Ember", "Rock Throw", "Flame Charge", "Rock Slide", "Fire Fang", "Stone Edge", "Flamethrower", "Earth Power"], designer: "Dogtor Bloo", added: "2025-01-11" },
    ...
    { row: 9,  name: "Bidoof (Angel)",         group: "bidoof", where: ["Snowy Peaks", "Stony Peaks", "Jagged Peaks", "Frozen Peaks"], types: ["Fairy", "Flying"], ability: "Serene Grace / Simple (hidden: Moody)", stats: [65, 35, 45, 65, 70, 40], role: "Special support", moves: ["Gust", "Fairy Wind", "Draining Kiss", "Wish", "Air Cutter", "Dazzling Gleam", "Air Slash", "Moonblast", "Roost", "Fly"], designer: "rabitt", added: "2025-02-14" },
    { row: 10, name: "Bidoof (King)",          group: "bidoof", where: ["Plains"], types: ["Normal", "Ground"], ability: "Intimidate / Simple (hidden: Moody)", stats: [65, 75, 55, 30, 45, 50], role: "Physical tank", moves: ["Mud-Slap", "Bulldoze", "Body Slam", "Dig", "Stomping Tantrum", "Earthquake", "Bulk Up"], designer: "Lazaro", added: "2025-03-03" },
    { row: 11, name: "Bidoof (Queen)",         group: "bidoof", where: ["Plains"], types: ["Psychic", "Fairy"], ability: "Queenly Majesty / Simple (hidden: Moody)", stats: [65, 35, 50, 75, 60, 35], role: "Special attacker", moves: ["Confusion", "Fairy Wind", "Disarming Voice", "Psybeam", "Calm Mind", "Psychic", "Moonblast", "Dazzling Gleam"], designer: "Lazaro", added: "2025-03-03" },
    ...
    { row: 13, name: "Bidoof (Kratos)",        group: "bidoof", where: ["Jagged Peaks", "Frozen Peaks"], types: ["Fighting", "Ghost"], ability: "Defiant / Simple (hidden: Moody)", stats: [60, 90, 55, 30, 45, 40], role: "Glass cannon", moves: ["Rock Smash", "Shadow Sneak", "Double Kick", "Brick Break", "Shadow Claw", "Close Combat", "Phantom Force", "Bulk Up"], designer: "Bowtie", added: "2025-03-28" },
    { row: 14, name: "Bidoof (Aloy)",          group: "bidoof", where: ["Jungle"], types: ["Grass", "Steel"], ability: "Sniper / Simple (hidden: Moody)", stats: [60, 80, 60, 35, 45, 40], role: "Physical attacker", moves: ["Vine Whip", "Metal Claw", "Razor Leaf", "Iron Head", "Seed Bomb", "Leaf Blade", "Flash Cannon", "Swords Dance"], designer: "Bowtie", added: "2025-03-28" },
    { row: 15, name: "Bidoof (Ratchet & Clank)", group: "bidoof", where: ["Trial Chambers"], types: ["Steel", "Electric"], ability: "Analytic / Simple (hidden: Moody)", stats: [60, 40, 55, 80, 45, 40], role: "Special attacker", moves: ["Thunder Shock", "Metal Claw", "Spark", "Flash Cannon", "Charge Beam", "Thunderbolt", "Iron Head", "Wild Charge", "Volt Switch"], designer: "Bowtie", added: "2025-03-28" },
    { row: 16, name: "Bidoof (Astro Bot)",     group: "bidoof", where: ["The End"], types: ["Electric", "Flying"], ability: "Motor Drive / Simple (hidden: Moody)", stats: [60, 40, 55, 60, 55, 50], role: "Fast special attacker", moves: ["Thunder Shock", "Gust", "Spark", "Air Cutter", "Electro Ball", "Air Slash", "Discharge", "Roost", "Volt Switch"], designer: "Bowtie", added: "2025-03-28" },
    { row: 17, name: "Bidoof (Sly Cooper)",    group: "bidoof", where: ["Taiga"], types: ["Dark", "Ghost"], ability: "Pickpocket / Simple (hidden: Moody)", stats: [60, 60, 55, 35, 55, 55], role: "Sneaky physical attacker", moves: ["Thief", "Astonish", "Feint Attack", "Shadow Sneak", "Sucker Punch", "Shadow Claw", "Knock Off", "Foul Play", "U-turn", "Phantom Force"], designer: "Bowtie", added: "2025-03-28" },
    { row: 18, name: "Bidoof (Mario)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Crimson Forest", "Warped Forest"], types: ["Fire", "Fighting"], ability: "Blaze / Simple (hidden: Moody)", stats: [60, 70, 45, 60, 45, 40], role: "Mixed attacker", moves: ["Ember", "Rock Smash", "Flame Charge", "Double Kick", "Fire Fang", "High Jump Kick", "Flare Blitz", "Flamethrower"], designer: "Bowtie", added: "2025-04-19" },
    { row: 19, name: "Bidoof (Luigi)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Warped Forest"], types: ["Ghost", "Electric"], ability: "Cursed Body / Simple (hidden: Moody)", stats: [60, 45, 50, 70, 50, 45], role: "Special attacker", moves: ["Thunder Shock", "Astonish", "Shadow Sneak", "Spark", "Hex", "Shadow Ball", "Discharge", "Will-O-Wisp", "Thunderbolt"], designer: "Bowtie", added: "2025-04-19" },
    { row: 20, name: "Bidoof (Wario)",         group: "bidoof", where: ["Badlands"], types: ["Poison", "Dark"], ability: "Stench / Simple (hidden: Moody)", stats: [70, 65, 55, 30, 50, 50], role: "Bulky physical attacker", moves: ["Poison Gas", "Acid", "Bite", "Poison Fang", "Crunch", "Poison Jab", "Knock Off", "Toxic"], designer: "Bowtie", added: "2025-04-19" },
    { row: 21, name: "Bidoof (Waluigi)",       group: "bidoof", where: ["Mushroom Fields"], types: ["Dark", "Fairy"], ability: "Prankster / Simple (hidden: Moody)", stats: [60, 45, 50, 65, 55, 45], role: "Trickster / special", moves: ["Feint Attack", "Baby-Doll Eyes", "Disarming Voice", "Torment", "Draining Kiss", "Dark Pulse", "Play Rough", "Nasty Plot", "Taunt"], designer: "Bowtie", added: "2025-04-19" },
    ...
    { row: 23, name: "Bidoof (Zelda, Breath of the Wild)", group: "bidoof", where: ["Sunflower Plains"], types: ["Grass", "Flying"], ability: "Wind Rider / Simple (hidden: Moody)", stats: [60, 45, 50, 65, 55, 45], role: "Special attacker", moves: ["Vine Whip", "Gust", "Razor Leaf", "Air Cutter", "Magical Leaf", "Air Slash", "Energy Ball", "Leaf Storm", "Roost"], designer: "Bowtie", added: "2025-04-19" },
