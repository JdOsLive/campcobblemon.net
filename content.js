...
window.CC = {
  ...
  seasons: [
    ...
    },
    {
      ...
      bannerAlt: "Season 2 banner art: Counselor Bidoof in a ranger hat waving at sunset, with Spider-Man Bidoof, Campion Koffing and Campion Weezing around a pine forest.",
      bannerCredit: "SirPlnguin",
      shots: [],
  ...
  pokemon: [
    { row: 5,  name: "Bidoof (Helldivers)",    group: "bidoof", where: ["The End"], series: "PlayStation", types: ["Steel", "Fighting"], ability: "Justified / Simple (hidden: Moody)", stats: [60, 85, 65, 30, 45, 35], role: "Armored bruiser", rarity: "Ultra Rare", moves: ["Metal Claw", "Rock Smash", "Brick Break", "Iron Head", "Body Press", "Close Combat", "Flash Cannon", "Bulk Up"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in The End. It appears to be in some kind of advanced getup.", designer: "maashous", added: "2025-01-06" },
    { row: 6,  name: "Bidoof (Barbie)",        group: "bidoof", where: ["Desert"], series: "Barbie", types: ["Fairy"], ability: "Cute Charm / Simple (hidden: Moody)", stats: [65, 35, 50, 75, 55, 40], role: "Special attacker", rarity: "Ultra Rare", moves: ["Baby-Doll Eyes", "Fairy Wind", "Disarming Voice", "Draining Kiss", "Dazzling Gleam", "Moonblast", "Play Rough", "Calm Mind"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in desert areas. It appears to be mimicking some sort of famous female icon.", designer: "maashous", added: "2025-01-06" },
    { row: 7,  name: "Bidoof (Ruby)",          group: "bidoof", where: ["Snowy Peaks", "Stony Peaks", "Jagged Peaks", "Frozen Peaks"], series: "Oshi no Ko", types: ["Rock", "Fire"], ability: "Solid Rock / Simple (hidden: Moody)", stats: [65, 80, 60, 40, 35, 40], role: "Physical wall-breaker", rarity: "Ultra Rare", moves: ["Ember", "Rock Throw", "Flame Charge", "Rock Slide", "Fire Fang", "Stone Edge", "Flamethrower", "Earth Power"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the mountains. It resembles a cheerful, high-spirited renowned idol from a distant land.", designer: "Dogtor Bloo", added: "2025-01-11" },
    { row: 8,  name: "Bidoof (Aqua)",          group: "bidoof", where: ["Snowy Peaks", "Stony Peaks", "Jagged Peaks", "Frozen Peaks"], series: "Oshi no Ko", types: ["Water", "Ice"], ability: "Swift Swim / Simple (hidden: Moody)", stats: [60, 40, 50, 70, 55, 45], role: "Rain sweeper", rarity: "Ultra Rare", moves: ["Water Gun", "Powder Snow", "Aqua Jet", "Icy Wind", "Surf", "Ice Shard", "Hydro Pump", "Scald", "Rain Dance"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the mountains. It resembles a calm, collected famous actor from a distant land.", designer: "Dogtor Bloo", added: "2025-01-11" },
    { row: 9,  name: "Bidoof (Angel)",         group: "bidoof", where: ["Snowy Peaks", "Stony Peaks", "Jagged Peaks", "Frozen Peaks"], series: "Camp original", types: ["Normal", "Fairy"], ability: "Serene Grace / Simple (hidden: Moody)", stats: [65, 35, 50, 70, 60, 40], role: "Special support", rarity: "Ultra Rare", moves: ["Fairy Wind", "Draining Kiss", "Wish", "Round", "Dazzling Gleam", "Hyper Voice", "Moonblast", "Calm Mind", "Fly"], flavor: "A variation of Bidoof from Camp Cobblemon in a divine angel outfit. It seems to appear when many people are celebrating love for each other.", designer: "rabitt", added: "2025-02-14" },
    { row: 10, name: "Bidoof (King)",          group: "bidoof", where: ["Plains"], series: "Camp original", types: ["Normal", "Psychic"], ability: "Dazzling / Simple (hidden: Moody)", stats: [70, 70, 60, 30, 50, 40], role: "Physical royal", rarity: "Ultra Rare", moves: ["Quick Attack", "Body Slam", "Zen Headbutt", "Stomping Tantrum", "Double-Edge", "Psychic Fangs", "Bulk Up"], flavor: "A variation of Bidoof from Camp Cobblemon in a noble king outfit. Bidoof looks especially majestic with the shining crown.", designer: "Lazaro", added: "2025-03-03" },
    { row: 11, name: "Bidoof (Queen)",         group: "bidoof", where: ["Plains"], series: "Camp original", types: ["Normal", "Psychic"], ability: "Queenly Majesty / Simple (hidden: Moody)", stats: [70, 30, 50, 70, 60, 40], role: "Special royal", rarity: "Ultra Rare", moves: ["Confusion", "Round", "Psybeam", "Calm Mind", "Hyper Voice", "Psychic", "Dazzling Gleam"], flavor: "A variation of Bidoof from Camp Cobblemon in an elegant queen outfit. Bidoof looks especially enchanting with the gleaming tiara.", designer: "Lazaro", added: "2025-03-03" },
    { row: 12, name: "Bidoof (Scuba)",         group: "bidoof", where: ["Ocean", "Deep Ocean"], series: "Camp original", types: ["Water"], ability: "Volt Absorb / Simple (hidden: Moody)", stats: [70, 60, 60, 45, 55, 30], role: "Bulky water", rarity: "Ultra Rare", moves: ["Water Gun", "Bubble", "Aqua Jet", "Waterfall", "Dive", "Aqua Tail", "Liquidation", "Surf", "Rain Dance"], flavor: "A variation of Bidoof from Camp Cobblemon. It appears to be properly equipped with some kind of diving gear.", designer: "Lazaro", added: "2025-03-03" },
    ...
    { row: 14, name: "Bidoof (Aloy)",          group: "bidoof", where: ["Jungle"], series: "PlayStation", types: ["Grass", "Steel"], ability: "Sniper / Simple (hidden: Moody)", stats: [60, 80, 55, 35, 45, 45], role: "Physical attacker", rarity: "Ultra Rare", moves: ["Vine Whip", "Metal Claw", "Razor Leaf", "Iron Head", "Seed Bomb", "Leaf Blade", "Flash Cannon", "Swords Dance"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in deep jungles. It seems to have come from an odd, distant place where robots animals are the norm.", designer: "Bowtie", added: "2025-03-28" },
    { row: 15, name: "Bidoof (Ratchet & Clank)", group: "bidoof", where: ["Trial Chambers"], series: "PlayStation", types: ["Steel", "Flying"], ability: "Analytic / Simple (hidden: Moody)", stats: [60, 40, 55, 70, 50, 45], role: "Special attacker", rarity: "Ultra Rare", moves: ["Metal Claw", "Gust", "Air Cutter", "Flash Cannon", "Charge Beam", "Air Slash", "Iron Head", "Steel Beam", "Roost", "Volt Switch"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in trial chambers. Seems to resemble a peculiar pair: a lombax and a robot with a knack for adventure.", designer: "Bowtie", added: "2025-03-28" },
    { row: 16, name: "Bidoof (Astro Bot)",     group: "bidoof", where: ["The End"], series: "PlayStation", types: ["Electric"], ability: "Motor Drive / Simple (hidden: Moody)", stats: [60, 40, 60, 55, 55, 50], role: "Fast special attacker", rarity: "Ultra Rare", moves: ["Thunder Shock", "Gust", "Spark", "Air Cutter", "Electro Ball", "Air Slash", "Discharge", "Roost", "Volt Switch"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in The End. This Bidoof is told of being a symbol of celebration among a certain video game company.", designer: "Bowtie", added: "2025-03-28" },
    { row: 17, name: "Bidoof (Sly Cooper)",    group: "bidoof", where: ["Taiga"], series: "PlayStation", types: ["Dark"], ability: "Pickpocket / Simple (hidden: Moody)", stats: [60, 75, 50, 35, 55, 45], role: "Sneaky physical attacker", rarity: "Ultra Rare", moves: ["Thief", "Quick Attack", "Feint Attack", "Bite", "Sucker Punch", "Night Slash", "Knock Off", "Foul Play", "U-turn", "Taunt"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the taigas. It is said this Bidoof is a master thief, coming from a long line of legendary thieves. ", designer: "Bowtie", added: "2025-03-28" },
    { row: 18, name: "Bidoof (Mario)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Crimson Forest", "Warped Forest"], series: "Mario", types: ["Fire"], ability: "Blaze / Simple (hidden: Moody)", stats: [60, 70, 45, 60, 45, 40], role: "Mixed attacker", rarity: "Ultra Rare", moves: ["Ember", "Rock Smash", "Flame Charge", "Double Kick", "Fire Fang", "High Jump Kick", "Flare Blitz", "Flamethrower"], flavor: " A variation of Bidoof from Camp Cobblemon that can be found in the crimson forests of the Nether. It appears that this Bidoof loves jumping down pipes and stomping Goombas.", designer: "Bowtie", added: "2025-04-19" },
    { row: 19, name: "Bidoof (Luigi)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Warped Forest"], series: "Mario", types: ["Ice"], ability: "Refrigerate / Simple (hidden: Moody)", stats: [60, 70, 50, 45, 50, 45], role: "Physical attacker (ice balls)", rarity: "Ultra Rare", moves: ["Powder Snow", "Ice Shard", "Ice Fang", "Avalanche", "Icicle Crash", "Double-Edge", "Blizzard", "Ice Beam"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the warped forests of the Nether. A timid Bidoof that tends to look for its partner.", designer: "Bowtie", added: "2025-04-19" },
    { row: 20, name: "Bidoof (Wario)",         group: "bidoof", where: ["Badlands"], series: "Mario", types: ["Poison"], ability: "Stench / Simple (hidden: Moody)", stats: [70, 60, 55, 40, 55, 40], role: "Bulky physical attacker", rarity: "Ultra Rare", moves: ["Poison Gas", "Acid", "Bite", "Poison Fang", "Crunch", "Poison Jab", "Knock Off", "Toxic"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the badlands. It likes to only surround itself with money and constantly says 'WAHAHAHAHA'.", designer: "Bowtie", added: "2025-04-19" },
    { row: 21, name: "Bidoof (Waluigi)",       group: "bidoof", where: ["Mushroom Fields"], series: "Mario", types: ["Dark", "Poison"], ability: "Prankster / Simple (hidden: Moody)", stats: [60, 45, 55, 60, 55, 45], role: "Trickster / special", rarity: "Ultra Rare", moves: ["Feint Attack", "Acid", "Snarl", "Torment", "Dark Pulse", "Sludge Bomb", "Foul Play", "Nasty Plot", "Taunt"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the mushroom fields. Live, Laugh, Waluigi.", designer: "Bowtie", added: "2025-04-19" },
    { row: 22, name: "Bidoof (Donkey Kong)",   group: "bidoof", where: ["Jungle"], series: "Mario", types: ["Fighting", "Grass"], ability: "Gorilla Tactics / Simple (hidden: Moody)", stats: [70, 85, 55, 30, 45, 35], role: "Physical bruiser", rarity: "Ultra Rare", moves: ["Rock Smash", "Vine Whip", "Bullet Seed", "Brick Break", "Seed Bomb", "Hammer Arm", "Wood Hammer", "Bulk Up"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the jungles. It searches the trees of the jungle biome for bananas, which don't spawn.", designer: "Bowtie", added: "2025-04-19" },
    { row: 23, name: "Bidoof (Zelda, Breath of the Wild)", group: "bidoof", where: ["Sunflower Plains"], series: "Zelda", types: ["Grass"], ability: "Wind Rider / Simple (hidden: Moody)", stats: [60, 45, 50, 65, 55, 45], role: "Special attacker", rarity: "Ultra Rare", moves: ["Vine Whip", "Gust", "Razor Leaf", "Air Cutter", "Magical Leaf", "Air Slash", "Energy Ball", "Leaf Storm", "Roost"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the sunflower plains. Resembles a princess from a faraway land that has discovered ancient technology.", designer: "Bowtie", added: "2025-04-19" },
    { row: 24, name: "Bidoof (Zelda, Echoes of Wisdom)",   group: "bidoof", where: ["Cherry Grove"], series: "Zelda", types: ["Psychic"], ability: "Magic Bounce / Simple (hidden: Moody)", stats: [60, 35, 50, 75, 55, 45], role: "Special support", rarity: "Ultra Rare", moves: ["Confusion", "Psybeam", "Calm Mind", "Psyshock", "Psychic", "Future Sight", "Reflect", "Light Screen"], flavor: "A variation of Bidoof from Camp Cobblemon that can be found in the cherry groves. Resembles a princess from a faraway land protects her people.", designer: "Bowtie", added: "2025-04-19" },
    { row: 33, name: "Bidoof (Camper)",        group: "bidoof", where: ["Forest", "Taiga", "Plains", "Meadow"], series: "Camp original", types: ["Normal"], ability: "Intimidate / Simple (hidden: Moody)", stats: [75, 58, 51, 45, 51, 40], role: "Well-rounded camper", rarity: "Rare", moves: ["Camouflage", "Round", "Nature Power", "Body Slam", "Bulk Up", "Double-Edge", "Slack Off", "Rest", "Work Up"], flavor: "A variation of Bidoof from Camp Cobblemon, at home in forests, plains and meadows. It comes prepared for a night outdoors and carries a pack of its own. The camp's favourite.", designer: "tortu152", added: "2026-09-11" },
    { row: 34, name: "Bidoof (Spider-Man)",   group: "bidoof", where: ["Towns and cities", "Villages"], series: "Marvel", types: ["Bug", "Flying"], ability: "Anticipation / Simple (hidden: Moody)", stats: [55, 75, 55, 35, 45, 55], role: "Fast physical attacker", rarity: "Ultra Rare", moves: ["String Shot", "Quick Attack", "Bug Bite", "Aerial Ace", "Spider Web", "Lunge", "X-Scissor", "Skitter Smack", "U-turn", "Agility"], flavor: "A variation of Bidoof from Camp Cobblemon that turns up wherever people build towns and cities. It wears the mask of a famous web-slinging hero, and senses danger before it arrives.", designer: "tortu152", added: "2026-09-11" },
    { row: 35, name: "Bidoof (Subaru)",       group: "bidoof", where: ["Dark Forest, at night"], series: "Re:Zero", types: ["Ghost", "Dragon"], ability: "Sturdy / Simple (hidden: Moody)", stats: [65, 40, 55, 70, 45, 45], role: "Refuses to stay down", rarity: "Ultra Rare", moves: ["Astonish", "Dragon Breath", "Endure", "Hex", "Dragon Pulse", "Destiny Bond", "Shadow Ball", "Protect", "Dragon Dance"], flavor: "A variation of Bidoof from Camp Cobblemon that appears in dark forests at night. It resembles a boy from another world who refuses to stay down, however many times it falls. Trainers swear it already knows how the battle ends.", designer: "tortu152", added: "2026-09-11" },
    { row: 36, name: "Bidoof (Counselor)",       group: "bidoof", where: ["Any biome, in daylight", "Near cake or crops"], series: "Camp original", types: ["Normal", "Dragon"], ability: "Natural Cure / Simple (hidden: Moody)", stats: [70, 40, 50, 70, 45, 45], role: "Bulky support", rarity: "Super Rare", moves: ["Round", "Dragon Breath", "Life Dew", "Hyper Voice", "Dragon Pulse", "Body Slam", "Draco Meteor", "Calm Mind", "Heal Bell"], flavor: "A variation of Bidoof from Camp Cobblemon that turns up by day wherever food has been set out. It wears the hat and coat of someone trusted to look after a camp, and it takes the duty seriously. It will not leave until everyone has eaten.", designer: "tortu152 / SirPlnguin", added: "2026-09-11" },
    { row: 37, name: "Bidoof (Deadpool)",        group: "bidoof", where: ["Pillager Outposts"], series: "Marvel", types: ["Dark", "Fighting"], ability: "Regenerator / Simple (hidden: Moody)", stats: [70, 80, 45, 35, 45, 45], role: "Reckless attacker", rarity: "Ultra Rare", moves: ["Scratch", "Fury Cutter", "Sucker Punch", "Slash", "Brick Break", "Night Slash", "Close Combat", "Swords Dance", "Taunt"], flavor: "A variation of Bidoof from Camp Cobblemon found near the outposts of hostile folk. Wrapped head to tail in red, it shrugs off wounds that would fell anything else, and it has never once been observed to stop talking.", designer: "tortu152", added: "2026-09-11" },
    { row: 38, name: "Bidoof (Wolverine)",       group: "bidoof", where: ["Snowy Taiga"], series: "Marvel", types: ["Steel"], ability: "Sharpness / Simple (hidden: Moody)", stats: [65, 85, 55, 25, 45, 45], role: "Berserker", rarity: "Ultra Rare", moves: ["Metal Claw", "Fury Swipes", "Slash", "Bite", "Iron Head", "Night Slash", "Crunch", "Swords Dance", "Close Combat"], flavor: "A variation of Bidoof from Camp Cobblemon that prowls the snowy taiga alone. Claws of an unknown metal slide from its paws without warning, and no injury seems to slow it for long.", designer: "tortu152", added: "2026-09-11" },
    ...
    { row: 39, name: "Campion Koffing",   group: "campion", species: "Koffing",   dex: "#109", form: "Campion form", types: ["Poison", "Fire"], rarity: "Rare",       where: ["Basalt Deltas", "Soul Sand Valley", "Nether Wastes"], ability: "Levitate / Flash Fire (hidden: Flame Body)", flavor: "A variation of Koffing from Camp Cobblemon that drifts through the ash and soul sand of the Nether. Pale and hollow-eyed, it hangs in the air like something that never quite finished dying, and the gas it leaks catches fire the moment it touches lava.", designer: "SirPlnguin / Stillet", added: "2026-09-15", stats: [45, 70, 100, 70, 55, 40] },
    { row: 40, name: "Campion Weezing",   group: "campion", species: "Weezing",   dex: "#110", form: "Campion form", types: ["Poison", "Fire"], rarity: "Ultra Rare", where: ["Basalt Deltas", "Soul Sand Valley", "Nether Wastes"], how: "Evolve Campion Koffing at level 35", ability: "Levitate / Flash Fire (hidden: Flame Body)", flavor: "A variation of Weezing from Camp Cobblemon found deep in the Nether. Two heads, a tangle of trailing tentacles, and a wail that carries across the wastes. The smoke it breathes is hot enough to melt netherrack, and campers who hear it say the lava goes quiet.", designer: "SirPlnguin / Stillet", added: "2026-09-15", stats: [70, 95, 130, 95, 80, 65] }
  ],
