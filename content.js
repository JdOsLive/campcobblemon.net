...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 33, name: "Bidoof (Scout)",        group: "bidoof", where: ["Forest", "Taiga", "Plains", "Meadow"], types: ["Normal"], ability: "Fur Coat / Simple (hidden: Moody)", stats: [75, 58, 51, 45, 51, 40], role: "Well-rounded camper", rarity: "Rare", moves: ["Camouflage", "Round", "Nature Power", "Body Slam", "Bulk Up", "Double-Edge", "Slack Off", "Rest", "Work Up"], designer: "TBC", added: "2026-09-07" },
    { row: 34, name: "Bidoof (Spider-Man)",   group: "bidoof", where: ["Towns and cities", "Villages"], types: ["Bug"], ability: "Anticipation / Simple (hidden: Moody)", stats: [55, 80, 50, 35, 45, 55], role: "Fast physical attacker", rarity: "Ultra Rare", moves: ["String Shot", "Quick Attack", "Bug Bite", "Spider Web", "Agility", "Lunge", "X-Scissor", "Skitter Smack", "U-turn", "Sticky Web"], designer: "TBC", added: "2026-09-07" },
    { row: 35, name: "Bidoof (Subaru)",       group: "bidoof", where: ["Dark Forest, at night"], types: ["Ghost", "Dragon"], ability: "Sturdy / Simple (hidden: Moody)", stats: [65, 40, 55, 70, 45, 45], role: "Refuses to stay down", rarity: "Ultra Rare", moves: ["Astonish", "Dragon Breath", "Endure", "Hex", "Dragon Pulse", "Destiny Bond", "Shadow Ball", "Protect", "Dragon Dance"], designer: "TBC", added: "2026-09-07" },
