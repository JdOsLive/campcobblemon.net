...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 33, name: "Bidoof (Camper)",        group: "bidoof", where: ["Forest", "Taiga", "Plains", "Meadow"], types: ["Normal"], ability: "Intimidate / Simple (hidden: Moody)", stats: [75, 58, 51, 45, 51, 40], role: "Well-rounded camper", rarity: "Rare", moves: ["Camouflage", "Round", "Nature Power", "Body Slam", "Bulk Up", "Double-Edge", "Slack Off", "Rest", "Work Up"], flavor: "A variation of Bidoof from Camp Cobblemon, at home in forests, plains and meadows. It comes prepared for a night outdoors and carries a pack of its own. The camp's favourite.", designer: "tortu152", added: "2026-09-07" },
    { row: 34, name: "Bidoof (Spider-Man)",   group: "bidoof", where: ["Towns and cities", "Villages"], types: ["Bug", "Flying"], ability: "Anticipation / Simple (hidden: Moody)", stats: [55, 75, 55, 35, 45, 55], role: "Fast physical attacker", rarity: "Ultra Rare", moves: ["String Shot", "Quick Attack", "Bug Bite", "Aerial Ace", "Spider Web", "Lunge", "X-Scissor", "Skitter Smack", "U-turn", "Agility"], flavor: "A variation of Bidoof from Camp Cobblemon that turns up wherever people build towns and cities. It wears the mask of a famous web-slinging hero, and senses danger before it arrives.", designer: "tortu152", added: "2026-09-07" },
    { row: 35, name: "Bidoof (Subaru)",       group: "bidoof", where: ["Dark Forest, at night"], types: ["Ghost", "Dragon"], ability: "Sturdy / Simple (hidden: Moody)", stats: [65, 40, 55, 70, 45, 45], role: "Refuses to stay down", rarity: "Ultra Rare", moves: ["Astonish", "Dragon Breath", "Endure", "Hex", "Dragon Pulse", "Destiny Bond", "Shadow Ball", "Protect", "Dragon Dance"], flavor: "A variation of Bidoof from Camp Cobblemon that appears in dark forests at night. It resembles a boy from another world who refuses to stay down, however many times it falls. Trainers swear it already knows how the battle ends.", designer: "tortu152", added: "2026-09-07" },
