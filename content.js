...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 19, name: "Bidoof (Luigi)",         group: "bidoof", where: ["Basalt Deltas", "Nether Wastes", "Warped Forest"], types: ["Ice"], ability: "Refrigerate / Simple (hidden: Moody)", stats: [60, 70, 50, 45, 50, 45], role: "Physical attacker (ice balls)", moves: ["Powder Snow", "Ice Shard", "Ice Fang", "Avalanche", "Icicle Crash", "Double-Edge", "Blizzard", "Ice Beam"], designer: "Bowtie", added: "2025-04-19" },
