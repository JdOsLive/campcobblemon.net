...
window.CC = {
  ...
  pokemon: [
    ...
    { row: 20, name: "Bidoof (Wario)",         group: "bidoof", where: ["Badlands"], types: ["Poison"], ability: "Stench / Simple (hidden: Moody)", stats: [70, 60, 55, 35, 55, 45], role: "Bulky physical attacker", rarity: "Ultra Rare", moves: ["Poison Gas", "Acid", "Bite", "Poison Fang", "Crunch", "Poison Jab", "Knock Off", "Toxic"], designer: "Bowtie", added: "2025-04-19" },
