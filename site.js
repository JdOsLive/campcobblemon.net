(function () {
  ...
  // ---- shiny weekend (Thursday 7 PM -> Sunday midnight, Eastern; must match shinyStartDay/Hour
  //      in the server's config/campradio.json, which is what actually applies the boost) ----
